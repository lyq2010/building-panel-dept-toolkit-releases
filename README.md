...
| 版本 | 适用系统 | 下载入口 | 安装文件 |
|---|---|---|---|
| Windows 通用版 | Windows x64 | [Latest](https://github.com/lyq2010/lee-releases/releases/latest) | `packing-list-toolkit_*_x64-setup.exe` |
| Lee's Toolbox Windows | Windows 11 22H2 及以上 x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/tag/lees-toolbox-windows-v1.1.3) | `lees-toolbox-windows_*_x64-setup.exe` |
| macOS 通用版 | Apple Silicon | [Latest](https://github.com/lyq2010/lee-releases/releases/latest) | `packing-list-toolkit_*_arm64.dmg` |
...
| Lee's Mail | Windows 11 22H2 及以上 x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/tag/lees-mail-v1.0.0) | `LeesMail_*_x64.msix` |
